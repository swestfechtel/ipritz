...
public class SearchLocationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private ImageButton deliveryBackButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deliveryBackButton = findViewById(R.id.delivery_back_button);

        deliveryBackButton.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(SearchLocationActivity.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(SearchLocationActivity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
    ...
    //search a location
    public void geoLocate(EditText searchText){
