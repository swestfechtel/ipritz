...
public class BookingOrderActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mapFragment.getMapAsync(BookingOrderActivity.this);
    ...
    public void geoLocateFrom(EditText searchText){
        ...
        if(searchString != null) {
            ...
            Geocoder geocoder = new Geocoder(BookingOrderActivity.this);
