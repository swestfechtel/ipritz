...
public class DeliveryActivity extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    public boolean isServicesOK(){
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(DeliveryActivity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
